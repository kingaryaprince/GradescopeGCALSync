...
Icons are generated by a script in the commit history rather than a design tool. They are flat
and squared to match, and the 16px variant uses **simplified geometry** (bigger body, thicker
header rule, larger date mark) because the detailed one turns to mush at toolbar size.
